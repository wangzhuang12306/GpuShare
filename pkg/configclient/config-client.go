...
const (
	SchedulerIpPath = "/gpushare/library/schedulerIP.txt"
	SchedulerGPUConfigPath = "/gpushare/scheduler/config/"
	SchedulerGPUPodManagerPortPath = "/gpushare/scheduler/podmanagerport/"

	SchedulerPodIpEnvName = "GPUSHARE_SCHEDULER_IP"
)
